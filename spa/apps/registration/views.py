...
def activate(request, backend,
    ...
    **Template:**
    ...
    # add the number of days the activation link is valid
...
def register(request, backend, success_url=None, form_class=None,
    ...
    **Template:**
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            new_user = backend.register(request, form)
            ...
            if not is_ajax_request:
                ...
                res.update({'status': 'OK', 'redirect': request.POST.get('next',r''), 'message': ''})
